...
void* value_to_data(Value* val, ColumnType type) {
    ...
    printf("Error: type mismatch - cannot convert ");
    if (val->type == VAL_INT) printf("INT");
    else if (val->type == VAL_FLOAT) printf("FLOAT");
    else if (val->type == VAL_STRING) printf("STRING");
    else printf("UNKNOWN");
    printf(" to ");
    if (type == TYPE_INT) printf("INT");
    else if (type == TYPE_FLOAT) printf("FLOAT");
    else if (type == TYPE_STRING) printf("STRING");
